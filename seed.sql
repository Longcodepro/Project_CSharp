...
-- Seed note:
-- - U001 / U002 la tai khoan listener local-dev.
-- - Quy uoc password: idname + 123.
-- - Tat ca password trong file nay la bcrypt hash khop voi quy uoc tren.
...
(
    ...
    (
        ...
        'listener_one',
        N'Listener One',
        'listener.one@gmail.com',
        '$2a$11$lnKkKowhvVwIcPwsp/XcM.Pu5Xj/ap7Q995.uugQk3Pjmv14.B6b2',
        -- Password: listener_one123
        '/uploads/avatars/Default.png',
        N'Tài khoản nghe nhạc mẫu cho kiểm thử local. Dùng để xác minh các luồng đăng nhập, nghe nhạc và tương tác cơ bản của người dùng không phải artist.',
        0,
        0,
        SYSDATETIME(),
        1
    ...
    (
        ...
        'listener_two',
        N'Listener Two',
        'listener.two@gmail.com',
        '$2a$11$rgRPIOoQcaTbmXd4AnHLJeTSufXyURqWmtxuFhEUW9GLBNxinx5fS',
        -- Password: listener_two123
        '/uploads/avatars/Default.png',
        N'Tài khoản nghe nhạc mẫu thứ hai để test follow, friend, share và history giữa nhiều user listener.',
        0,
        0,
        SYSDATETIME(),
        1
    ...
    (
        ...
        '$2a$11$NBoRnhy2zfF.O.sqS6IH9el0BB6nwdA1SwF.7hAL0IPmEfVG3PJra',
        -- Password: sontungmtp123
        '/uploads/avatars/Default.png',
    ...
    (
        ...
        '$2a$11$.8qLMXkDYjxy6bSaEw7gIuG6U847j6pX0mNi2bPy8ZWUnaw2vlpuO',
        -- Password: justinbieber123
    ...
    (
        ...
        N'Shakira',
        'shakira@gmail.com',
        '$2a$11$U4rxtnchn2QLSOSzSkHHxe3py.4TWtv7qoN3QgOWQ32.y7hH80zqu',
        -- Password: shakira123
    ...
    (
        ...
        N'MONO',
        'mono@gmail.com',
        '$2a$11$/zJmuBm1xGvtFN4geg.2bO9BMQ7DMsDRitK/eNsD.3EOj6pT9HgSm',
        -- Password: mono123
    ...
    (
        ...
        N'SOOBIN',
        'soobin@gmail.com',
        '$2a$11$gKD2Ry/2InaVjcwtM0xSUuI/7Dm/loj9SIZHXoakBQXck7TXiusby',
        -- Password: soobin123
...
(
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/hay-trao-cho-anh.mp3',
        NULL,
        '/uploads/default-cover/Default.png',
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/chay-ngay-di.mp3',
        NULL,
        '/uploads/media-covers/chay-ngay-di.jpg',
        NULL,
        N'Dark Pop, R&B',
        8,
        1,
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/chung-ta-cua-hien-tai.mp3',
        NULL,
        '/uploads/media-covers/chung-ta-cua-hien-tai.png',
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/come-my-way.mp3',
        NULL,
        '/uploads/media-covers/come-my-way.png',
        '/uploads/canvas/come-my-way.mp4',
        N'Pop, Hip-hop',
        50,
        1,
        76,
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/baby.mp3',
        NULL,
        '/uploads/media-covers/baby.png',
        NULL,
        N'Teen Pop, Pop',
        34,
        1,
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/beauty-and-a-beat.mp3',
        NULL,
        '/uploads/media-covers/beauty-and-a-beat.png',
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/la-la-la-brasil-2014.mp3',
        NULL,
        '/uploads/media-covers/la-la-la-brasil-2014.png',
        NULL,
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/hips-dont-lie.mp3',
        NULL,
        '/uploads/media-covers/hips-dont-lie.png',
        NULL,
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/em-xinh.mp3',
        NULL,
        '/uploads/media-covers/em-xinh.png',
        NULL,
        N'V-pop, Pop',
        30,
        1,
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/waiting-for-you.mp3',
        NULL,
        '/uploads/media-covers/waiting-for-you.png',
        NULL,
        N'V-pop, Pop, R&B',
        25,
        1,
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/em.mp3',
        NULL,
        '/uploads/media-covers/em.png',
        NULL,
        N'Pop, R&B',
        40,
        1,
    ...
    (
        ...
        @SongMediaType,
        '/uploads/media/xin-dung-lang-im.mp3',
        NULL,
        '/uploads/media-covers/xin-dung-lang-im.png',
        NULL,
        N'Ballad, V-pop',
        20,
        1,
