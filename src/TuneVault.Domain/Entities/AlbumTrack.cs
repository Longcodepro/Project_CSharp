...
public class AlbumTrack
{
    ...
    /// </summary>
    /// <param name="id">Mã định danh duy nhất của AlbumTrack (Độ dài tối đa 5 ký tự).</param>
    /// <param name="albumId">Mã định danh Album liên kết (Độ dài tối đa 5 ký tự).</param>
    /// <param name="mediaItemId">Mã định danh MediaItem liên kết (Độ dài tối đa 5 ký tự).</param>
    ...
    /// <exception cref="DomainException">Ném ra khi Id trống hoặc vượt quá 5 ký tự.</exception>
    ...
    /// <exception cref="DomainException">Ném ra khi AlbumId trống hoặc vượt quá 5 ký tự.</exception>
    ...
    /// <exception cref="DomainException">Ném ra khi MediaItemId trống hoặc vượt quá 5 ký tự.</exception>
