...
public sealed class NotificationController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAll([FromQuery] int limit = 50, CancellationToken ct = default)
    {
        ...
        var result = await _mediator.Send(new GetNotificationsQuery(userId, limit), ct);
    ...
    public async Task<IActionResult> GetUnread([FromQuery] int limit = 50, CancellationToken ct = default)
    {
        ...
        var result = await _mediator.Send(new GetUnreadNotificationsQuery(userId, limit), ct);
    ...
    public async Task<IActionResult> MarkAsRead(string notificationId, CancellationToken ct)
    {
        ...
        var result = await _mediator.Send(new MarkNotificationAsReadCommand(notificationId, userId), ct);
        return result
    ...
    public async Task<IActionResult> MarkAllAsRead(CancellationToken ct)
    {
        ...
        var count = await _mediator.Send(new MarkAllNotificationsAsReadCommand(userId), ct);
    ...
    public async Task<IActionResult> Delete(string notificationId, CancellationToken ct)
    {
        ...
        var result = await _mediator.Send(new DeleteNotificationCommand(notificationId, userId), ct);
        return result
